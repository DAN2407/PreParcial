...
public class CourseRepository implements JpaRepository<Course, UUID> {
    @Override
    public void flush() {
    ...
    @Override
    public Course getOne(UUID uuid) {
        return null;
    }

    @Override
    public Course getById(UUID uuid) {
        return null;
    }

    @Override
    public Course getReferenceById(UUID uuid) {
        return null;
    }
    ...
    @Override
    public List<Course> findAllById(Iterable<UUID> uuids) {
        return List.of();
    }
